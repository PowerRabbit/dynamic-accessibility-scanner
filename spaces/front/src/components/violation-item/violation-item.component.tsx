...
import type { AccessibilityIssue } from '@/pages/scan/scan.types';
import './violation-item.component.css';
import { ScanPageContextExporter } from '../../pages/scan/scan.context';
...
export const ViolationItem: FC<ViolationItemProps> = ({ violation: v, index: i }) => {
    const { removeChild, cloneChild } = ScanPageContextExporter();
